...
public class HoaDonDAO {
    ...
    public boolean gopBan(String maBanBiGop, String maBanChinh) {
        ...
        if (maHDChinh == null || maHDBiGop == null) return false;
        ...
        try {
            ...
            // BƯỚC 1: Nếu 2 bàn có gọi CÙNG 1 MÓN -> Cộng dồn số lượng và thành tiền vào HD Chính
            String sqlUpdateTrung = "UPDATE cChinh "
                    + "SET cChinh.soLuong = cChinh.soLuong + cGop.soLuong, "
                    + "    cChinh.thanhTien = cChinh.thanhTien + cGop.thanhTien "
                    + "FROM ChiTietHoaDon cChinh "
